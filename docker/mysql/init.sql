...
ALTER DATABASE hotel_sistema CHARACTER
SET
...
-- ========== SEED ==========
INSERT INTO
  cliente (cedula, nombre, tipo_identificacion)
VALUES
...
INSERT INTO
  reserva_huesped (id_reserva, id_huesped, fecha_reserva)
VALUES
  (1, 7891011, '2025-05-28');

INSERT INTO
  categoria_cama (tipo, medidas, foto_url, color)
VALUES
  (
    'Queen',
    '160x200',
...
INSERT INTO
  cama (serial, fecha_cama, id_categoriacama)
VALUES
  ('Queen', '2025-05-28', 1);
...
VALUES
  (
    ...
    'Habitación con vista al mar y todas las comodidades',
    true,
    true,
    true,
    true,
...
INSERT INTO
  cama_habitacion (id_cama, id_habitacion, estado)
VALUES
  (1, 1, 'Libre');

INSERT INTO
  reserva_habitacion (id_reserva, id_habitacion, cantidad)
VALUES
  (1, 1, 1);

INSERT INTO
  recepcion_habitacion (fecha, id_habitacion, categoria)
VALUES
  ('2025-05-28', 1, 'Checkin');

INSERT INTO
  recepcion_huesped (id_recepcion, id_huesped, fecha_recepcion)
VALUES
  (1, 7891011, '2025-05-28');